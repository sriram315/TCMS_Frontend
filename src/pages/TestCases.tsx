    ...
    <>
      {!isTestCaseLoading ? (
                      ...
                      <ul className="divide-y divide-gray-200 ">
                        {Object.keys(categorizedTestCases).map((section) => (
                          <li key={section} className="">
                            <button
                              title={section.length > 21 ? section : ""}
                      ...
                      <tbody>
                        {selectedSection
                          ? categorizedTestCases[selectedSection]
                              ...
                              .sort(
                                (a, b) =>
                                  String(a?.projectMap?.[projectId]) -
                                    String(b?.projectMap?.[projectId]) &&
                                  String(a?.module) - String(b?.module) &&
                                  String(a?.testCaseId) - String(b?.testCaseId)
                              )
                              .map((testCase: any) => (
                                <tr
                                  key={testCase._id}
        ...
        <div className="space-y-3">
          <div className="flex justify-between items-start animate-pulse gap-8">
